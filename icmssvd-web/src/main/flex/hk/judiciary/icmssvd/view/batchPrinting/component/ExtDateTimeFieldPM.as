package hk.judiciary.icmssvd.view.batchPrinting.component
{
	...
	import hk.judiciary.icms.view.shared.vo.LocaleCodeTableVO;
	import hk.judiciary.icms.view.shared.vo.MessageInfoVO;
	import hk.judiciary.icms.view.shared.vo.ValidateResultVO;
	import hk.judiciary.icmssvd.view.shared.component.CommonUtils;
	import hk.judiciary.icmssvd.view.batchPrinting.component.ExtDateTimeField;
	import hk.judiciary.icmssvd.view.shared.dataObject.BDDObject;
	...
	public class ExtDateTimeFieldPM extends CommonUI
	{
		public function ExtDateTimeFieldPM()
		{
		}
		...
		private var _viewObject:ExtDateTimeField;
		private var _codeTableVOs:ArrayCollection = new ArrayCollection();
		
		public function init(viewObject:ExtDateTimeField):void {
